...
public class Trips {
    ...
    /**
     *
     * @Deprecated Stores the name of the airport from which the traveler will depart 
     */
    private String AirportOfDeparture;  
     /**
     *
     * @Deprecated Stores the name of the airport to which the traveler will arrive 
     */
    private String AirportOfDestination; 
     /**
     *
     * @Deprecated Stores the code of the city from which the traveler will depart
     */
     ...
     *
     * @param Company
     * @Deprecated to determine the time of departure and arrival of the aircraft, according to the airline
     */
     ...
     *
     * @param period
     * @Deprecated to determine the flight number and some of its specifications, depending on the selected period
     */
   ...
   //-------setters methods----------
     ...
     *
     * @param YesOrNo
     * @Deprecated This method tests the number entered by the user and returns a boolean value based on that
     */
    public void setYesOrNo(int YesOrNo) {
     if ( YesOrNo==1) {this.YesOrNo=true;}
     else if ( YesOrNo==2) {this.YesOrNo=false;}}
