...
public class FirstCompanyMeals extends MealsCompany implements TripMeals {
    //Saudi Arabian Airlines Meals
    //-------data feild----------

    /**
     * @Deprecated An array that stores the types of meals in Saudi Arabian
     * Airlines
     */
    ...
    public void AdvanceReservationOfMeals() {
        ...
        System.out.println("At the present time, reservations for meals are on board,"
                + " \n meaning that there is no prior reservation available in the Saudi airline");
