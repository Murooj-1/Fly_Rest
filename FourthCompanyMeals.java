...
public class FourthCompanyMeals extends MealsCompany implements TripMeals {
    //JAZEERA Meals
    //-------data feild----------
    /**
     * @Deprecated An array that stores the types of meals in JAZEERA
     */
    ...
    public void AdvanceReservationOfMeals() {
        ...
        System.out.println("At the present time, reservations for meals are on board,"
                + "\n  meaning that there is no prior reservation available in the Jazeera airline");
